...
<a class="ws-nav-card" href="#angles">
  ...
  <div class="ws-nav-card-sub">Junior / طموح رئيس / صاحب شركة</div>
</a>
...
| البند | التفاصيل |
|-------|----------|
| **المحاضر** | أ/ محمد ريان (محاسب قانوني + خبير ضرائب) |
| **عدد المحاضرات** | 8 محاضرات Live · 5 محاضرات Udemy |
| **مدة المحاضرة** | 4 ساعات (Live) · 1.3 ساعة (Udemy) |
| **إجمالي الساعات** | 32 ساعة Live · 6.5 ساعة Udemy |
| **الجمهور** | Junior 1-3 سنين · يـ بغى رئيس حسابات |
...
??? info "📚 المحاور التفصيلية (من الـ Flyer)"
    ...
    **الجزء الثاني — مستوى رئيس الحسابات:**
    ...
    🔹 **معالجة القروض** — قصيرة + طويلة الأجل + الفوائد + التسديد

    !!! tip "ميزة الورشة"
        دي **الورشة الوحيدة في الأكاديمية** اللي بـ تـ غطي معيار المخزون رقم 2 بـ شكل عملي + معالجة القروض من الصفر للسداد.

??? info "📱 النسخة Udemy (مسجلة — Lifetime access)"
    ...
    **متى تعرضها:**
    ...
    🔹 العميل في محافظة بعيدة + مش هـ ينفع Live
...
??? note "👨‍🏫 عن المحاضر — أ/ محمد ريان"
    ...
    **محاسب قانوني + خبير ضرائب** — بـ يـ راجع شركات وبـ يـ شوف الأخطاء العملية.
...
!!! danger "⚠️ الإسكندرية — قواعد لا تـ نقض"
...
<a class="angle-card" href="angle-1-stuck-junior/">
  ...
  <span class="angle-card-meta">شغّال 1-3 سنين · بـ يـ عمل نفس الشغل · مش بـ يـ تعلم</span>
  <span class="angle-card-pain">"بـ كتب نفس القيود كل شهر — مش بـ يـ زيد عليّ معرفة، مش بـ يـ زيد مرتب"</span>
</a>
...
<a class="angle-card" href="angle-2-aspiring-chief/">
  ...
  <span class="angle-card-meta">junior بـ سنتين خبرة · يـ بغى ترقية</span>
  <span class="angle-card-pain">"رئيس حسابات بـ يـ عمل التسويات والقوائم وأنا واقف."</span>
</a>
...
<a class="angle-card" href="angle-3-business-owner/">
  ...
  <span class="angle-card-pain">"محاسبي بـ يكلمني بـ مصطلحات وأنا مش فاهم."</span>
</a>
...
??? warning "\"5800ج كتير\""
    ...
    **R:**
    ...
    > 🔹 **Bundle Multi-booking:** لو ضفت ورشة تانية، الإجمالي يـ نزل
...
??? warning "\"32 ساعة كتير\""
    ...
    **R:**
    ...
    > 🔹 **بعد الشغل (6م-10م)** — ما بـ يـ ضارش جدولك
    > 🔹 **Recording متاح** — لو فاتك يوم
    >
    > بديل: **Udemy 6.5 ساعة** كـ بداية، ولو الـ Live ناسب لاحقاً، تكمل.

??? warning "\"المحاضر بـ يـ شرح عربي ولا إنجليزي؟\""

    **R:** **عربية كاملة**. المصطلحات الفنية (debit, credit, balance sheet) بـ يـ شرحها بـ العربي + يـ ذكر الـ term الإنجليزي. مناسبة لـ اللي إنجليزيه ضعيف.

??? warning "\"الشامل = المالي + رئيس حسابات. ليه ما أخدش الاتنين منفصلين؟\""

    **R:** **مفيش ورشة 'رئيس حسابات' منفصلة** — الـ Senior knowledge بـ يـ بنى على foundation قوي. الفصل بـ يـ كسر الـ flow + الـ value بـ يـ نخفض.
...
??? danger "❌ ممنوع نهائياً"
    ...
    🔹 ❌ تـ بيع الـ Udemy لـ junior جاد — Live أنسب
    🔹 ❌ "كورس"
