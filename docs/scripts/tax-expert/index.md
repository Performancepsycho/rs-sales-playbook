...
<a class="ws-nav-card" href="#angles">
  ...
  <div class="ws-nav-card-sub">3 angles · Specialist / Owner</div>
</a>
...
| البند | التفاصيل |
|-------|----------|
| **المحاضر** | أ/ أحمد علي (خبير ضرائب — شغّال في الفحص) |
...
??? info "📚 المحاور"
    ...
    🔹 معايير المحاسبة المصرية المرتبطة بـ الضرايب
    🔹 تعديلات قانون الضرايب الأخيرة
    🔹 النظام الضريبي الموحّد للـ small business
    🔹 **case studies حقيقية** من شركات اتفحصت

??? note "👨‍🏫 المحاضر — أ/ أحمد علي"

    **خبير ضرايب شغّال في الفحص الضريبي فعلياً.**

    🔹 "بيشوف الفحص من الجانبين — الفاحص + المحاسب"
    🔹 "بيدّيك الـ red flags اللي بيبحثوا عنها"
